...
- First call `skill__load {"name":"gh-fix-ci"}` and read `skill.skill_root`.
- `python "<skill_root>/scripts/inspect_pr_checks.py" --repo "." --pr "<number-or-url>"`
...
Usage examples:
- `python "<skill_root>/scripts/inspect_pr_checks.py" --repo "." --pr "123"`
- `python "<skill_root>/scripts/inspect_pr_checks.py" --repo "." --pr "https://github.com/org/repo/pull/123" --json`
- `python "<skill_root>/scripts/inspect_pr_checks.py" --repo "." --max-lines 200 --context 40`
